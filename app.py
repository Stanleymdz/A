...
def check_banned(player_id):
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            result = {
                "creditos": "@LEOMODZOFCC",
                "channel": "https://t.me/Sigma_labs",
...
def bancheck():
    ...
    if not player_id:
        return Response(json.dumps({"error": "É necessário o ID do jogador", "status_code": 400}), mimetype="application/json")
